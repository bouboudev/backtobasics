...
<div align="center">
  ...
  <h2 align="center">App music</h>

  <p align="center">
   this is an App music in vue !
    <br />
...
The goal of the project was to create a mini music application. Give the possibility to the user to select a music to play pause go to the next or previous music, using the framework javascript Vue.js.
